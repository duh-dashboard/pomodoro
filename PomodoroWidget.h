...
class PomodoroWidget : public QObject, public dashboard::IWidget {
    Q_OBJECT
    Q_INTERFACES(dashboard::IWidget)
    Q_PLUGIN_METADATA(IID IWidget_iid FILE "pomodoro.json")

public:
    explicit PomodoroWidget(QObject* parent = nullptr);
...
private:
    int workMinutes_       = 25;
    int shortBreakMinutes_ = 5;
    int longBreakMinutes_  = 15;
    int totalPomodoros_    = 0;
};
